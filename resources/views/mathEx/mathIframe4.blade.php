...
.correctAnswer{
	...
	<section class="top-letest-product-section">
	    ...
	    <div id="sectionMain">
	        ...
	        <p class="nameOfExP">What is <span id="choiceOne"></span> <span id="PorM"> </span> <span id="choiceTwo"></span>  </p>
        ...
        <script>
                ...
                let choice1 = randomIntFromInterval(1, 100);
                let choice2 = randomIntFromInterval(1, 100);
                let PorM = randomIntFromInterval(1,2);
                if(PorM == 1){
                    PorM = "+"
                } else {
                    PorM = "-"
                ...
                document.querySelector('#PorM').textContent = PorM;
